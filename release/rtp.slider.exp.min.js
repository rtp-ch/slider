...
(function(){var a={add:function(a){var f=a.handler;a.handler=function(a){var e=f.call(this,a);if(!1==e||a.isPropagationStopped()){var b=a.type,d=a.isTrigger,c=a.isPropagationStopped,m=a.isImmediatePropagationStopped;a.type="trap"+a.type;a.isPropagationStopped=function(){return!1};a.isImmediatePropagationStopped=function(){return!1};jQuery(a.currentTarget).parent().trigger(a);a.type=b;a.isTrigger=d;c&&a.stopPropagation();m&&a.stopImmediatePropagation();if("undefined"!=typeof e)return e}}}};"onmousedown"in
...
(function(a,g){function f(a){var e=this.conf.offsetReverse;return this.conf.vertical^a?e?"marginBottom":"marginTop":e?"marginRight":"marginLeft"}a.getContainerOffset=function(a){return-(parseFloat(this.container.css(f.call(this,a)),10)||0)};a.setContainerOffset=function(a,e){a=parseInt(a+0.5);this.container.css(f.call(this,e),-a);this.ct_off=a};a.readContainerOffset=function(){this.ct_off=this.getContainerOffset(0)};a.checkContainerOffset=function(){var a=this.getContainerOffset(0);if(this.ct_off!==
...
d=this.pd[0][b]*(a-b),d=d+this.offset[b];h&&(d+=this.offset[this.smax+1]*e);return d};a.getPositionByOffset=function(a,h){a=parseInt(a+0.5,10);var e=this.offset[this.smin],b=this.offset[this.smax+1],d=this.conf.alignPanelDim+this.smin,c=0,m=0;if(this.conf.carousel&&b>e){for(;a<e;)c--,a+=b-e;for(;b<=a;)c++,a-=b-e}else{if(a<=e)return this.smin;if(a>=b)return this.smax+1}for(e=this.panels.length;e--;){var b=this.offset[e+0],g=this.offset[e+1];if(b==a)return e-d;if(g>a&&a>b)return h&&(m=c*(this.smax+
1)),(a-b)/(g-b)+e-d+m}throw"getPositionByOffset has invalid state";};a.plugin("layout",function(){this.position=this.slide2slide(this.position)},-999);a.plugin("layout",function(){this.setOffsetByPosition(this.position)},999)})(RTP.Slider.prototype,jQuery);
...
(function(a,g){function f(){if(!0===this.isReady&&"viewportByPanels"==this.conf.sizerOpp){var a=1E100,e=[],b=this.se,d=parseFloat(this.conf.autoVpOppDeadZone,10),c=parseFloat(this.conf.autoVpOppLifeZone,10);isNaN(d)&&(d=0.2);isNaN(c)&&(c=0.8);if(d>c)var f=d,d=c,c=f;0==b.length&&eval("debugger");0==this.pd[1].length&&eval("debugger");for(f=b.length;f--;){var g=this.smin+f;0<b[f]&&this.pd[1][g]<a&&(a=this.pd[1][g])}for(f=b.length;f--;)g=this.smin+f,0!==b[f]&&(b[f]>c?e.push(this.pd[1][g]-a):b[f]>d&&
e.push((this.pd[1][g]-a)*(b[f]-d)/(c-d)));e=Math.max.apply(Math,e);this.updateViewportOpp(a+e)}}a.plugin("config",function(a){a({autoVpOppDeadZone:0.2,autoVpOppLifeZone:0.8})});a.plugin("adjustViewport",f,9999);a.plugin("changedPosition",f,9999);a.plugin("foobarVisibility",f,9999)})(RTP.Slider.prototype,jQuery);
...
d=0,e=a.length;d<e;d+=b){for(var f=0,g=0,k=0;k<b&&d+k<e;k++)f+=a[d+k],g++;f=Math.pow(f/g,b);for(k=0;k<b&&d+k<e;k++)h.call(this,d,f)}else for(d=0;d<a.length;d++)h.call(this,d,a[d])}function b(a){if(this.navDot){a||(a=this.conf);a=a.panelsVisible;this.navDotCountClass&&(this.navDotWrapper.remoteClass(this.navDotCountClass),this.navDotCountClass=null);this.conf.navDotCountClass&&(this.navDotCountClass=this.klass.navDotCount+a,this.navDotWrapper.addClass(this.navDotCountClass));for(var b=0;b<this.slides.length;b++){var d=
0==b%a?"":"none";this.navDot.eq(b).css("display",d)}}}var d=g.isFunction;a.plugin("updating",function(a){("groupPanels"in a&&a.groupPanels||this.conf.groupPanels)&&a.panelsVisible!=this.conf.panelsVisible&&b.call(this,a)});a.plugin("config",function(a){a({navDots:!1,navDotWrappers:!1,navDotPosition:"append",navDotCountClass:!0,navDotAltFormat:f,navDotTitleFormat:f,navDotStepFunction:function(a,b){this.navDotImg.eq(a).css("opacity",b)},klass:{navDot:"rtp-nav-dot",navDotCount:"rtp-nav-dot-count-",panelHidden:"rtp-nav-dot-hidden",
panelPartial:"rtp-nav-dot-partial",panelVisible:"rtp-nav-dot-visible"},tmpl:{navDotWrapper:['<span><a href="javascript:void(0);">',"</a></span>"],navDotElement:'<img src="img/rtp-nav-dot-clear.gif" width="12" height="12" alt=""/>'},selector:{navDotImage:"IMG"}})});a.plugin("init",function(){var a=this,e=a.tmpl,f=a.conf;if(f.navDots&&1<a.slides.length){a.navDot=g();a.navDotImg=g();a.navDotWrapper=g('<div class="rtp-nav-dots">');a.slides.each(function(b){var l=g(e.navDotWrapper[0]+e.navDotElement+e.navDotWrapper[1]).addClass(a.klass.navDot).addClass([a.klass.navDot,
b].join("-")).click(function(){a.animate(a.conf.fader?"f"+b:"="+b,null,null,null,!0)}).appendTo(a.navDotWrapper),k=g(f.selector.navDotImage,l);d(f.navDotAltFormat)&&k.attr("alt",f.navDotAltFormat.call(a,b));d(f.navDotTitleFormat)&&k.attr("title",f.navDotTitleFormat.call(a,b));a.navDot.push(l.get(0));a.navDotImg.push(k.get(0));h.call(a,b,0)});var p=a.wrapper[f.navDotPosition];p&&p.call(a.wrapper,a.navDotWrapper);f.navDotWrappers&&(a.navDotWrapper.wrap('<div class="rtp-nav-dots-outer">'),a.navDotWrapper.wrap('<div class="rtp-nav-dots-wrapper">'))}b.call(this)});
a.plugin("changedVisibility",e);a.plugin("foobarVisibility",e)})(RTP.Slider.prototype,jQuery);
...
f[e-2][0]>f[e-1][0]&&f[e-1][0]<a&&(f.length=0));50<f.length&&f.shift();f.push([a,d,(new Date).getTime()]);if(!c.swipeDrag)return!0;this.trigger("swipeDraw",c);return!c.swipeDrag});a.plugin("swipeStop",function(a,d,c){this.trigger("abortAnimation");var f=c.swipeMoves;this.trigger("swipeMove",a,d,c,0,0);this.undefer("swipeDraw");for(var g=(new Date).getTime()-500,p=Math.floor(this.conf.panelsVisible);f.length&&f[0][2]<g;)f.shift();g=e(f,this.vp_x/2)[0]*this.vp_x/2;f=Math.abs(g);g=0>g?-1:1;p=Math.pow(0.5*
f*p,0.5)*-g;p=h.call(this,c.swipeStartPosition,c.swipePosOff,p);this.locked=!1;this.trigger("abortAnimation");this.trigger("swipeFinish",a,d,c);a=0;d="linear";g=Math.abs(p);0.5<g?(d=0.375>f?"easeOutBounce":"easeOutExpo",a=Math.max(Math.min(100/Math.pow(1/f,1.5),9E3),1200)):0<g&&(d=0.375>f?"easeOutBounce":"easeOutExpo",a=Math.max(Math.min(100/Math.pow(1/f,1.5),2E3),600));f=c.swipeDrag;delete c.swipeDrag;delete c.swipeScroll;c.swipeMoves=[];this.animate(0>p?p:"+"+p,a,d,function(){this.swiping=this.foobar=
